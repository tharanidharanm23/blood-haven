      ...
      {loading ? (
        ...
        <div className="hud-panel p-12 text-center">
          ...
          <p className="text-muted-foreground font-mono text-xs uppercase tracking-widest">
            No active requests found in your area.
          </p>
        </div>
      ) : (
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-border border border-border">
          {filtered.map((r) => (
            <div
              key={r.id}
              className="bg-surface p-5 flex flex-col gap-4 h-full border border-transparent hover:border-primary/20 transition-all"
            >
              ...
              <div className="flex gap-2 mt-auto pt-2">
                ...
                <a
                  href={whatsappLink(
                    r.requesterPhone,
                    `Hi, I am a donor. I saw your request ${r.id} for ${r.units}U of ${r.bloodGroup}. I can help.`,
                  )}
                  target="_blank"
                  rel="noreferrer"
